...
@include('includes.rates', ['rates' => $rates])
 ...
 <div class="mission">
        ...
        <p class="text">
            But we’re not stopping here. <strong>Pravasify</strong> is evolving into a broader support hub for NRIs. In the near future, you’ll be able to compare <strong>courier services between India and Sweden</strong>, explore <strong>financial tools</strong> designed for expats, and access <strong>everyday resources tailored for the Indian community abroad</strong>.
        </p>
                    </div>
                </div>
            </div>
